...
var EndpointDialog = /** @class */ (function () {
    ...
    EndpointDialog.prototype.printDatabaseConfig = function (credentials) {
        var data = __assign({ connector: credentials.type, host: credentials.host
                ...
                ? credentials.schema
                : undefined, user: credentials.user, password: credentials.password, uri: credentials.uri ? this.replaceLocalhost(credentials.uri) : undefined }, ((credentials.type === prisma_datamodel_1.DatabaseType.postgres) ? __assign({ ssl: credentials.ssl }) : {}));
